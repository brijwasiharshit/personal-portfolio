    ...
    <footer className="bg-black py-8">
      <div className="text-center text-white">
        <p className="mb-4 text-lg">
          &copy; 2024 Made By Harshit Brijwasi. All rights reserved.
        </p>
        <hr className="w-8/12 mx-auto border-gray-700" />
        <p className="my-4 text-lg">Follow me on</p>
        <div className="flex justify-center space-x-6">
          ...
          <a
            href="https://www.linkedin.com/in/harshit-brijwasi-303774138/"
            className="text-blue-500 hover:text-blue-400 transition-colors duration-200"
          >
            <svg
              className="w-6 h-6 inline"
          ...
          <a
            href="https://github.com/brijwasiharshit"
            className="text-blue-500 hover:text-blue-400 transition-colors duration-200"
          >
            <svg
              className="w-6 h-6 inline"
