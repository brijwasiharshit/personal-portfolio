    ...
    <footer className="bg-black py-8">
      <div className="text-center text-white">
        ...
        <a href="https://instagram.com" className="text-blue-500 hover:text-blue-400 transition-colors duration-200">
          ...
          <a href="https://linkedin.com" className="text-blue-500 hover:text-blue-400 transition-colors duration-200">
            <svg className="w-6 h-6 inline" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://github.com" className="text-blue-500 hover:text-blue-400 transition-colors duration-200">
            <svg className="w-6 h-6 inline" fill="currentColor" viewBox="0 0 24 24">
